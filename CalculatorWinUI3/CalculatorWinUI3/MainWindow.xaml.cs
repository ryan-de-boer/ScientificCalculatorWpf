...
namespace CalculatorWinUI3
{
  /// <summary>
  /// WinUI3 Main Window for Calculator.
  /// </summary>
  public sealed partial class MainWindow : Window
  {
    ...
    /// <summary>
    /// Functions javascript code that needs to be sent every execute call.
    /// </summary>
    private String g_fns = "";
    ...
    public MainWindow()
    {
      ...
      appWindow.Resize(new SizeInt32(540, 380));

      string iconPath = System.IO.Path.Combine(System.AppDomain.CurrentDomain.BaseDirectory, "favicon.ico");
      appWindow.SetIcon(iconPath);

      Title = "Scientific Calculator";

      // Workaround WinUI3 bug where text goes black when mouse exits buttons.
      PadC.PointerExited += PadC_PointerExited;
      Equals.PointerExited += Equals_PointerExited;
    ...
    private void Click_Text(string text)
    {
      ...
      TanBar.Text += text;
      TanBar.SelectionStart = TanBar.Text.Length; // Move the caret to the end.
      TanBar.Focus(FocusState.Programmatic); // Set focus to the TextBox.
    }
    ...
    /// Stored in g_fns to be combined in each execute call.
    /// </summary>
    /// <param name="sender">Not used.</param>
    /// <param name="e">Not used.</param>
...
";
    ...
    /// <summary>
    /// Displays a MessageBox with supplied message and caption.
    /// </summary>
    /// <param name="message">Message.</param>
    /// <param name="caption">Caption.</param>
    private async void ShowMessageBox(string message, string caption)
    {
      // Create a ContentDialog for the MessageBox equivalent
      ...
      messageDialog.XamlRoot = TanBar.XamlRoot;
    ...
    private async void Apply()
    {
      ...
      String result = await webView.ExecuteScriptAsync(g_fns + "eval(" + input + ")");
      if (result == "null")
      {
        ShowMessageBox("Invalid input: " + input, "Error");
        return;
      }
      TanBar.Text = result;
      TanBar.SelectionStart = TanBar.Text.Length; // Move the caret to the end.
...
";
    ...
    /// <param name="sender">Not used.</param>
    /// <param name="e">Not used.</param>
    private async void TanBar_KeyDown(object sender, KeyRoutedEventArgs e)
    {
    ...
    /// <summary>
    /// Workaround WinUI3 bug where text goes black when mouse exits buttons. 
    /// Makes it white again.
    /// </summary>
    /// <param name="sender">Not used.</param>
    /// <param name="e">Not used.</param>
    private void Equals_PointerExited(object sender, PointerRoutedEventArgs e)
    {
      Equals.Foreground = new SolidColorBrush(Windows.UI.Color.FromArgb(255, 255, 255, 255));
    }
    ...
    /// <param name="sender">Not used.</param>
    /// <param name="e">Not used.</param>
    private void PadC_PointerExited(object sender, PointerRoutedEventArgs e)
    {
      PadC.Foreground = new SolidColorBrush(Windows.UI.Color.FromArgb(255, 255, 255, 255));
    }
